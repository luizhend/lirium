...
packet_ip_header_t* create_ip_header(size_t payload_len, uint8_t protocol,uint8_t dst[4], uint8_t mac_addr[6],uint8_t src[4]){
    printf(
    ...
    memcpy(header->src_mac, mac_addr, sizeof header->src_mac);
